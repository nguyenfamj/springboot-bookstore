...
public class BookstoreApplication {
	...
	public CommandLineRunner bookDemo(BookRepository repository) {
		return (args) -> {
			...
			repository.save(new Book("The Intelligent Investor", "Benjamin Graham", 2009, "9780061745171", 50.00));
			repository.save(new Book("Start-up nation", "Dan Senor", 2009, "9780446541473", 20.00));
